...
filemtime('C:\webserver\www\lizmap\lizmap/modules/view/templates/view.tpl') > 1652379068){ return false;
} else {
  ...
  <li class="span3 liz-repository-project-item">
    <div class="thumbnail">
      <div class="liz-project">
        <img src="<?php echo $t->_vars['p']->img; ?>" alt="project image" class="liz-project-img">
        <p class="liz-project-desc" style="display:none;">
          <b><?php echo $t->_vars['p']->title; ?></b>
          <br/>
          <br/><b><?php echo jLocale::get('default.project.abstract.label'); ?></b>&nbsp;: <?php echo jtpl_modifier_common_truncate(strip_tags($t->_vars['p']->abstract),100); ?>
